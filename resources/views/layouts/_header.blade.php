        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    ...
                    <li>
                        <a class="notifications-badge" href="{{ route('notifications.index') }}" style="margin-top: -2px;">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            @can('manage_contents')
                                <li>
                                    <a href="{{ url(config('administrator.uri')) }}" title="">
                            ...
                            <li>
                                ...
                                <span class="glyphicon glyphicon-out" aria-hidden="true"></span>
                                退出登录
                                </a>
